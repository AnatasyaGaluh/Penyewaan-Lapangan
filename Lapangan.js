...
import Slide1 from '../image/l1.jpg';
import Slide2 from '../image/l2.jpg';
        ...
        <div className=" container ">
            <div className="row">
                <div className="col-lg-3">
                    <h1 className="my-4">Penyewaan Lapangan</h1>
                                                ...
                                                <form onSubmit={this.Filter}>
                                                        <div className="form-group">
                                                                ...
                                                                onChange={this.bind} >
                                                                        ...
                                                                        <option value="locks">Voli</option>
                                                                        <option value="iotm">Basket</option>
                                                                        <option value="iotm">Futsal</option>
                                                                </select>
                                                        </div>
